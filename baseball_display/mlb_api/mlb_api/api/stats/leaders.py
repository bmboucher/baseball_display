...
from ...models.leaders_position import LeadersPosition
...
def _get_kwargs(
    *,
    ...
    leader_game_types: list[str] | Unset = UNSET,
    sit_codes: list[str] | Unset = UNSET,
    position: LeadersPosition | Unset = UNSET,
    ...
    json_leader_game_types: list[str] | Unset = UNSET
    if not isinstance(leader_game_types, Unset):
        json_leader_game_types = leader_game_types

    params["leaderGameTypes"] = json_leader_game_types
...
def sync_detailed(
    *,
     ...
     **Description:**
     This endpoint returns statistical data for top performers  information based on League Leader
    Categories.
    ...
    Args:
        ...
        leader_game_types (list[str] | Unset):
        sit_codes (list[str] | Unset):
        position (LeadersPosition | Unset):
