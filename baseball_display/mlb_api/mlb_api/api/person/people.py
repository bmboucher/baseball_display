...
def sync_detailed(
    *,
     ...
     **Description:**
     This endpoint returns statistical data and biographical information for a players,umpires, and
    coaches based on playerId.
    ...
    https://statsapi.mlb.com/api/v1/people?personIds=605151,592450&season=2018&hydrate=stats(type=byMont
    h),education
