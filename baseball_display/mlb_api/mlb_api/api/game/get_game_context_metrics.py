...
from ...models.game_context_rest_object import GameContextRestObject
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/game/{game_pk}/contextMetrics".format(
...
) -> Any | GameContextRestObject | None:
    if response.status_code == 200:
        response_200 = GameContextRestObject.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | GameContextRestObject]:
    return Response(
