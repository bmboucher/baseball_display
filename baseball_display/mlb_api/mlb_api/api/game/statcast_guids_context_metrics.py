...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/game/{game_pk}/{guid}/contextMetricsAverages".format(
...
def sync_detailed(
    ...
    **Example of call with required parameters**
    ...
    http://statsapi.mlb.com/api/v1/game/566885/25381bfd-e258-4064-8c54-
    628e6ae3bdab/contextMetricsAverages
