...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/game/{game_pk}/feed/color/diffPatch".format(
...
def sync_detailed(
    ...
    *,
     ...
     **Description:**
    This endpoint returns the difference/discrepancies between two timecodes in the Color Feed using the
    Diff Patch System.
    ...
    **Required Parameters:** all parameters are required to run this call. If incorrectly called the
    call will default to http://statsapi.mlb.com/api/v1/game/531304/feed/color
    <br></br>

    ---
    **Example of call with required parameters:**

    http://statsapi.mlb.com/api/v1.1/game/531321/feed/live/diffPatch?startTimecode=20180822_163853&endTi
    mecode=20180822_163938
