...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v1/teams/{team_id}/roster/{roster_type}".format(
            team_id=quote(str(team_id), safe=""),
            roster_type=quote(str(roster_type), safe=""),
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    **Description:**
     ...
     **Example of call with hydrated parameters**
     ...
     https://statsapi.mlb.com/api/v1/teams/109/roster/Active?season=2018&hydrate=person(stats(type=seaso
    n,season=2018),education),hydrations
