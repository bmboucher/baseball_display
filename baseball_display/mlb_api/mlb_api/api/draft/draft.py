...
from ...models.draft_position import DraftPosition
...
def _get_kwargs(
    ...
    *,
    ...
    position: DraftPosition | Unset = UNSET,
...
def sync_detailed(
    ...
    **Example of call with all parameters:**
    ...
    https://statsapi.mlb.com/api/v1/draft/2018?limit=1&round=1&name=M&school=A&position=P&teamId=116&pla
    yerId=663554&bisPlayerId=759143
